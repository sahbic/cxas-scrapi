...
Your task is to analyze the sub-agent instructions (`instruction.txt`) and point out any errors, style issues, ambiguities, and gaps in red-teaming / robustness scenarios.
